...
.field private k:Landroid/support/v7/internal/widget/af;
...
.method private a(Landroid/support/v7/app/ActionBarActivityDelegateBase$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/app/e;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method private a(Landroid/support/v7/app/ActionBarActivityDelegateBase$PanelFeatureState;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->k:Landroid/support/v7/internal/widget/af;
...
.method private a(Landroid/support/v7/internal/view/menu/i;Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->k:Landroid/support/v7/internal/widget/af;
...
.method private a(Landroid/support/v7/app/ActionBarActivityDelegateBase$PanelFeatureState;)Z
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/app/n;-><init>(Landroid/support/v7/app/ActionBarActivityDelegateBase;Landroid/content/Context;)V
...
.method private b(Landroid/support/v7/app/ActionBarActivityDelegateBase$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->k:Landroid/support/v7/internal/widget/af;
    ...
    iget-object v4, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->l:Landroid/support/v7/app/l;

    if-nez v4, :cond_9

    new-instance v4, Landroid/support/v7/app/l;

    invoke-direct {v4, p0, v7}, Landroid/support/v7/app/l;-><init>(Landroid/support/v7/app/ActionBarActivityDelegateBase;Landroid/support/v7/app/h;)V

    iput-object v4, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->l:Landroid/support/v7/app/l;
    ...
    iget-object v6, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->l:Landroid/support/v7/app/l;
...
.method private c(Landroid/support/v7/app/ActionBarActivityDelegateBase$PanelFeatureState;)Z
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->m:Landroid/support/v7/app/p;
    ...
    invoke-direct {v0, p0, v3}, Landroid/support/v7/app/p;-><init>(Landroid/support/v7/app/ActionBarActivityDelegateBase;Landroid/support/v7/app/h;)V

    iput-object v0, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->m:Landroid/support/v7/app/p;
...
.method static synthetic d(Landroid/support/v7/app/ActionBarActivityDelegateBase;I)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/app/ActionBarActivityDelegateBase;->b(I)V
...
.method private e(I)I
    ...
    invoke-static {v5, v1, v4}, Landroid/support/v7/internal/widget/bv;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method private e(ILandroid/view/KeyEvent;)V
    ...
    iget-object v2, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->k:Landroid/support/v7/internal/widget/af;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->k:Landroid/support/v7/internal/widget/af;

    invoke-interface {v2}, Landroid/support/v7/internal/widget/af;->d()Z
    ...
    invoke-static {v2}, Landroid/support/v4/view/bn;->a(Landroid/view/ViewConfiguration;)Z
...
.method a(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-direct {v0, p2, p3}, Landroid/support/v7/internal/widget/bh;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_1

    :pswitch_1
    new-instance v0, Landroid/support/v7/internal/widget/bo;

    invoke-direct {v0, p2, p3}, Landroid/support/v7/internal/widget/bo;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p2, p3}, Landroid/support/v7/internal/widget/be;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_1

    :pswitch_3
    new-instance v0, Landroid/support/v7/internal/widget/bl;

    invoke-direct {v0, p2, p3}, Landroid/support/v7/internal/widget/bl;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p2, p3}, Landroid/support/v7/internal/widget/bf;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p2, p3}, Landroid/support/v7/internal/widget/bc;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_1

    :pswitch_6
    new-instance v0, Landroid/support/v7/internal/widget/bk;

    invoke-direct {v0, p2, p3}, Landroid/support/v7/internal/widget/bk;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto/16 :goto_1

    :pswitch_7
    new-instance v0, Landroid/support/v7/internal/widget/bm;

    invoke-direct {v0, p2, p3}, Landroid/support/v7/internal/widget/bm;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p2, p3}, Landroid/support/v7/internal/widget/bd;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public b(Landroid/support/v7/b/b;)Landroid/support/v7/b/a;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/app/ActionBarActivityDelegateBase;->a(Landroid/support/v7/b/b;)Landroid/support/v7/b/a;
...
.method final n()V
    ...
    iput-object v0, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->k:Landroid/support/v7/internal/widget/af;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/af;->setWindowCallback(Landroid/support/v7/internal/a/a;)V
    ...
    invoke-static {v0}, Landroid/support/v7/internal/widget/bv;->b(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/app/ActionBarActivityDelegateBase;->a:Landroid/support/v7/app/e;

    invoke-virtual {v0, v7}, Landroid/support/v7/app/e;->findViewById(I)Landroid/view/View;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/ai;->setOnFitSystemWindowsListener(Landroid/support/v7/internal/widget/aj;)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/app/e;->a(Landroid/view/View;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/af;->setWindowTitle(Ljava/lang/CharSequence;)V
