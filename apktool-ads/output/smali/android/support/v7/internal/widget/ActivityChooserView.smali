...
.field private final d:Landroid/support/v7/widget/p;
...
.method private a(I)V
    ...
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/r;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/r;->d(I)V

    invoke-virtual {v3}, Landroid/support/v7/widget/r;->c()V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/view/g;
    ...
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/r;->g()Landroid/widget/ListView;
...
.method private getListPopupWindow()Landroid/support/v7/widget/r;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/r;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/r;

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/r;

    iget-object v1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/u;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/r;->a(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/r;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/r;->a(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/r;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/r;->a(Z)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/r;

    iget-object v1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->c:Landroid/support/v7/internal/widget/v;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/r;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/r;

    iget-object v1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->c:Landroid/support/v7/internal/widget/v;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/r;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->d:Landroid/support/v7/widget/p;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/p;->layout(IIII)V
...
.method public setProvider(Landroid/support/v4/view/g;)V
    ...
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/view/g;
