...
.field private l:Landroid/support/v7/widget/r;
...
.method public c()Landroid/support/v7/widget/r;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/r;
...
.method public d()Z
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Landroid/support/v7/widget/r;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/r;

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/r;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/r;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/r;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/r;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/r;

    iget-object v3, p0, Landroid/support/v7/internal/view/menu/v;->f:Landroid/support/v7/internal/view/menu/w;

    invoke-virtual {v2, v3}, Landroid/support/v7/widget/r;->a(Landroid/widget/ListAdapter;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/r;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/r;->a(Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/r;->a(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/r;

    iget v2, p0, Landroid/support/v7/internal/view/menu/v;->r:I

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/r;->b(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/r;->d(I)V

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/r;

    const/4 v2, 0x2

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/r;->e(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/r;->g()Landroid/widget/ListView;
...
.method public onDismiss()V
    ...
    iput-object v1, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/r;
